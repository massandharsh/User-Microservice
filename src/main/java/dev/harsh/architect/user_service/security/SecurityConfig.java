...
public class SecurityConfig {
    ...
    public SecurityFilterChain authorizationServerSecurityFilterChain(HttpSecurity http)
        ...
        http
                // Redirect to the login page when not authenticated from therole
...
//        //Here we have harcoded the details
...
//                .redirectUri("http://127.0.0.1:8080/login/oauth2/code/productService")
